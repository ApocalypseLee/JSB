    ...
    private void loadSplashAd() {
        ...
        mTTAdNative.loadSplashAd(adSlot, new TTAdNative.SplashAdListener() {
            ...
            public void onSplashAdLoad(TTSplashAd ad) {
                android.util.Log.d(TAG, "开屏广告请求成功");
                if (ad == null) {
                    return;
                }
                //获取SplashView
                android.view.View view = ad.getSplashView();
...
//                    mSplashContainer.removeAllViews();
                ...
                ad.setSplashInteractionListener(new TTSplashAd.AdInteractionListener() {
                    ...
                    public void onAdShow(android.view.View view, int type) {
                        android.util.Log.d(TAG, "onAdShow");
                        showToast("开屏广告展示");
                    }

                    @Override
                    public void onAdSkip() {
                        android.util.Log.d(TAG, "onAdSkip");
                        showToast("开屏广告跳过");
                        goToMainActivity();
                    ...
                    public void onAdTimeOver() {
                        android.util.Log.d(TAG, "onAdTimeOver");
                        showToast("开屏广告倒计时结束");
                        goToMainActivity();
                    }
                });
